...
class PostgresSearchRepository(PostgresSearchQuery, SearchRepositoryBase):
    ...
    def __init__(
        ...
        SearchRepositoryBase.__init__(self, session_maker, project_id)
        PostgresSearchQuery.__init__(self, session_maker, (project_id,))
