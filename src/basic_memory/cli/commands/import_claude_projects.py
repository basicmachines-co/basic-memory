...
def import_projects(
    projects_json: Annotated[Optional[Path], typer.Argument(..., help="Path to projects.json file")] = "projects.json",
    ...
    try:
        if projects_json:
            ...
            results = asyncio.run(process_projects_json(projects_json, base_path, markdown_processor))
