...
@pytest.mark.asyncio
async def test_write_note_with_project_parameter(multi_project_app, test_project, second_project, project_repository: ProjectRepository):
...
@pytest.mark.asyncio
async def test_read_note_with_project_parameter(multi_project_app, test_project, second_project, project_repository: ProjectRepository):
...
@pytest.mark.asyncio
async def test_search_notes_with_project_parameter(multi_project_app, test_project, second_project, project_repository: ProjectRepository):
...
@pytest.mark.asyncio  
async def test_delete_note_with_project_parameter(multi_project_app, test_project, second_project, project_repository: ProjectRepository):
...
@pytest.mark.asyncio
async def test_project_isolation(multi_project_app, test_project, second_project, project_repository: ProjectRepository):
...
async def test_current_project_fallback(multi_project_app, client):
    ...
    assert any("current project" in result.content.lower() for result in search_results.results if result.content)


@pytest.mark.asyncio
async def test_project_parameter_overrides_current(multi_project_app, test_project, second_project, project_repository: ProjectRepository):
...
@pytest.mark.asyncio
async def test_read_content_with_project_parameter(multi_project_app, test_project, second_project, project_repository: ProjectRepository):
    ...
    content_result = await read_content("files/Content Test File.md", project=second_project.permalink)
    # read_content returns a dict with the content in the 'text' field
    assert "Raw file content for testing" in str(content_result)


@pytest.mark.asyncio
async def test_canvas_with_project_parameter(multi_project_app, test_project, second_project, project_repository: ProjectRepository):
...
@pytest.mark.asyncio
async def test_recent_activity_with_project_parameter(multi_project_app, test_project, second_project, project_repository: ProjectRepository):
    ...
    assert "Recent Activity Test 2" in str(recent_results) or "second project" in str(recent_results)


@pytest.mark.asyncio
async def test_build_context_with_project_parameter(multi_project_app, test_project, second_project, project_repository: ProjectRepository):
    ...
    context_result = await build_context(
        url="memory://context/context-root-note",
        project=second_project.permalink
    )
